...
public class MyLeaveData {
    ...
    public int getLeaveAppliedCount() {
        return LeaveAppliedCount;
    }

    public void setLeaveAppliedCount(int leaveAppliedCount) {
        LeaveAppliedCount = leaveAppliedCount;
    }
    ...
    public String getLeaveTypeDetails() {
        return LeaveTypeDetails;
    }

    public void setLeaveTypeDetails(String leaveTypeDetails) {
    ...
    public String getLeaveBalanceYear() {
        return LeaveBalanceYear;
    }

    public void setLeaveBalanceYear(String leaveBalanceYear) {
        LeaveBalanceYear = leaveBalanceYear;
    }

    public int getLeaveBalanceYearID() {
        return LeaveBalanceYearID;
    }

    public void setLeaveBalanceYearID(int leaveBalanceYearID) {
        LeaveBalanceYearID = leaveBalanceYearID;
    }
    ...
    public String getLstLeave() {
        return lstLeave;
    }

    public void setLstLeave(String lstLeave) {
        this.lstLeave = lstLeave;
    }
    ...
    public String getLstBranch() {
        return lstBranch;
    }

    public void setLstBranch(String lstBranch) {
    ...
    public void setLstMonth(String lstMonth) {
    ...
    public void setLstYear(String lstYear) {
